...
export default function InvoicePage() {
  ...
  const {
    ...
    clearFilters,
    reloadData,
  } = usePagination(`/receipt-services?type=${BillType.RECEIPT_SERVICE}`);
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full">
              ...
              <tbody className="divide-y divide-gray-100">
                {receiptServices.map((invoice: any) => (
                    ...
                    <td className="px-6 py-4">
                      <div className="flex gap-2">
                        <button
                          onClick={() => {
                            setSelectedId(
                              invoice.bill ? invoice.bill.id : invoice.id
                            );
