...
export enum messageTranslation {
  ...
  SignOut = "ອອກຈາກລະບົບ",
  Unique = "ຂໍ້ມູນນີ້ມີຢູ່ແລ້ໃນລະບົບ ກະລຸນາກວດສອບຄືນ",
  ...
  CreatedBy = "ສ້າງໂດຍ",
  UpdatedBy = "ແກ້ໄຂລ່າສຸດໂດຍ",
  FullName = "ຊຶ່ແລະນາມສະກຸນ",

  PromoteToInvoice = "ປ່ຽນເປັນໃບບິນ",
  PromoteToReceipt = "ປ່ຽນເປັນໃບຈ່າຍເງີນ",
  PaidStatus = "ສະຖານະການຈ່າຍເງິນ",

  CreatedSuccess = "ການສ້າງສຳເລັດ",
  CreateFailed = "ການສ້າງຜິດພາດ",
  UpdatedSuccess = "ການອັບເດັດສຳເລັດ",
  UpdateFailed = "ການອັບເດັດຜິດພາດ",
  ...
  Invoice = "ໃບລາຍງານ",
  Quotation = "ໃບລ່ວງໜ້າ",
  BillService = "ໃບບໍລິການ",
  ReceiptService = "ໃບເກັບຄ່າບໍລິການ",
  CreatedAt = "ວັນທິສ້າງ",

  BillServiceNo = "ເລກທີໃບສຳລະ",
  ReceiptServiceNo = "ເລກທີໃບເກັບຄ່າບໍລິການ",
  InvoiceNo = "ເລກທີໃບບິນ",
  QuotationNo = "ເລກທີໃບລ່ວງໜ້າ",
